...
a048,79384,193000,3/13/0/16

We want output that looks like:

slurm_node_cpus_allocated{name="a048"} 3
slurm_node_cpus_idle{name="a048"} 3
slurm_node_cpus_other{name="a048"} 0
slurm_node_cpus_total{name="a048"} 16
slurm_node_mem_allocated{name="a048"} 179384
slurm_node_mem_total{name="a048"} 193000
